...
void main() {
  group("Test Class NoteRepository", () {
    ...
    test(
      "Test Method \"fetchNotesFromService\" Synchronizes Note Table With Service Data",
      () async {
    ...
    test("Test Method \"getNotes\" Returns Notes From Database", () async {
      noteGateway = NoteGateway(httpClientImplementation);
    ...
    test("Test Method \"getNote\" Returns Note From Database", () async {
    ...
    test(
      "Test Method \"getCreatedNote\" Creates Note On Database And On Service",
      () async {
        when(
    ...
    test(
      "Test Method \"getUpdatedNote\" Updates Note On Database And On Service",
      () async {
        when(
    ...
    test(
      "Test Method \"deleteNote\" Deletes Note On Database And On Service",
      () async {
        when(
